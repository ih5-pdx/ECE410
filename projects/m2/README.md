...
**Interface:** No change. AXI4-Lite remains the selected protocol as recorded
in `project/m1/interface_selection.md`.
...
No changes were made to `project/m1/interface_selection.md`.
